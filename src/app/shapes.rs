...
pub fn highlighting_clusters_of_scatter_points_with_circle_shapes(_plot: &mut Plot) {
    ...
    _plot.add_trace(Scatter::new(x0, y0.clone()).mode(Mode::Markers));
    _plot.add_trace(Scatter::new(x1.clone(), y1).mode(Mode::Markers));
    _plot.add_trace(Scatter::new(x2, y2).mode(Mode::Markers));
    _plot.add_trace(Scatter::new(x1, y0).mode(Mode::Markers));
